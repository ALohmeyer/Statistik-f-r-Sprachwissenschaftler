...
# Häufigkeiten entstehen: tabelle.prozent <- quantile(tabelle.rel)  
 print(quantile(tabelle.rel))

# Aber die Frage bleibt, wie berechnen wir den Modus? Durch sortieren!
# tabelle prozent <- sort(tabelle,decreasing=TRUE)
 print(tabelle.rel)
...
# nein es gibt nicht immer nur einen modalwert. der modus ist immer der höchste wert, der einer Variablen zugeordnet ist.
